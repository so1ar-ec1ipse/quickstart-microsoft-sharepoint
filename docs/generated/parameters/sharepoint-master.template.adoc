...
(`SQLLicenseProvided`)|`yes`|Choose yes to license SQL Server from AWS Marketplace. Choose no to provide your own license post-deployment.|SQL Server 2016 installation media location
...
(`SQL2019Media`)|`https://go.microsoft.com/fwlink/?linkid=866664`|SQL Server 2019 installation media location|Data volume size
